...
$("#loss").text(lost);
$("#computer").text(null)
$("#rps").attr("src","images/rps/rps.jpg");
$("#crps").attr("src","images/rps/computer.jpg")
...
$("#S").click(function(){
	$("#Throw").text(s);
	t = s
	$("#rps").attr("src","images/rps/Scissors.gif");
})

$("#R").click(function(){
	$("#Throw").text(r);
	t = r	
	$("#rps").attr("src","images/rps/the rock.gif");
})

$("#P").click(function(){
	$("#Throw").text(p);
	t = p
	$("#rps").attr("src","images/rps/paper.gif");
})
...
if(ct === "rock"){
$("#crps").attr("src","images/rps/the rock.gif")
} else if( ct === "paper"){
$("#crps").attr("src","images/rps/paper.gif")
}else{
$("#crps").attr("src","images/rps/Scissors.gif")
}

//displays the results in the picture
if(win == 1){
	if (t === "rock"){
		$("#result").attr("src","images/rps/rock wins.jpg")
	}
	else if(t === "paper"){
		$("#result").attr("src", "images/rps/paper wins.png")
	}
	else if(t==="scissors"){
		$("#result").attr("src", "images/rps/scissors win.gif")
	}
}
else if(win == 2){
	if (t === "rock"){
		$("#result").attr("src","images/rps/rock loses.jpg")
	}
	else if(t === "paper"){
		$("#result").attr("src","images/rps/pl.gif")
	}
	else if(t === "scissors"){
		$("#result").attr("src", "images/rps/scissors lose.gif")
	}
}
else{
	$("#result").attr("src","images/rps/head to head.jpg")
}
